...
- Do not claim complete static type safety: builtin identities are currently collapsed by the checker, while some assignment and comparison errors are caught only by the constrained simulator at runtime.
